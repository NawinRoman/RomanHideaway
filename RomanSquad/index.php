...
<head>
    ...
    <style>
        body {
            ...
            height: 100vh;
            margin: 0;
            background-color:rgb(0, 0, 0); /* สีพื้นหลังมืด */
            color: white; /* ข้อความเป็นสีขาว */
            flex-direction: column; /* ทำให้เนื้อหาของ body เรียงจากบนลงล่าง */
        }
...
<body>
    <!-- โลโก้จะออกมานอกกรอบ -->
    <img src="logo.png" alt="Roman Hideaway Logo" class="logo">
